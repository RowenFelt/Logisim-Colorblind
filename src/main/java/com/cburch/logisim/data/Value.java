...
public class Value {
	...
	public static final Color FALSE_COLOR = new Color(32, 59, 232); // blue is new False

	public static final Color TRUE_COLOR = new Color(244, 235, 66); // yellow is new True

	public static final Color UNKNOWN_COLOR = new Color(0, 255, 75); // green is new unknown

	public static final Color ERROR_COLOR = new Color(192, 0, 0);

	public static final Color WIDTH_ERROR_COLOR = new Color(239, 93, 234); // pink is new width error
